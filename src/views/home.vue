            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button type="button" class="col btn btn-secondary" data-dismiss="modal" @click="addCheckout(addItem, calculate, cashier, userName)">
                    Print
                  </button>
                  <button type="button" class="col btn btn-primary" data-dismiss="modal" @click="addCheckout(addItem, calculate, cashier, userName)">
                    Send Email
                  </button>
                </div>
              </div>
